...
<section>
    ...
    <article>
        <form action="join" method="post" name="joinForm">
            ...
            <div class="field"><label>Password</label><input type="password"  name="pwd" value="${dto.pwd}"></div>
            <div class="field">
                <label>Retype Password</label><input type="password"  name="pwdCheck" value="${dto.pwd}"></div>
            ...
            <div class="field">
                ...
                <div>
                    <input type="text" name="zip_num" id="sample6_postcode" value="${dto.zip_num}" readonly>
            ...
            <div class="field">
                <label>detail Address</label><input type="text" id="sample6_detailAddress" name="address2" value="${dto.address2}" />
            </div>
            <div class="field">
                <label>Extra Address</label><input type="text" id="sample6_extraAddress" name="address3" value="${dto.address3}" readonly/>
            </div>
