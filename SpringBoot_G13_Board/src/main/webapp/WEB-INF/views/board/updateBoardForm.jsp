...
<div id="main_container">
    ...
    <div class="board">
        <form class="insertBoard" method="post" name="insertBoard" action="updateBoard"
            ...
            <div class="field">
                <label>이메일</label>
                <input type="text" name="email" value="${board.email}" readonly/>
            </div>
            <div class="field">
            ...
            <div class="field">
                <label>이미지</label>
                <input type="button" value="파일 선택" onClick="selectImg()"/>            </div>
            <c:choose>
                ...
                <c:otherwise>
                    <div class="field">
                        ...
                        <div style="flex:4">
                            ...
                            <div id="image" style="float:left">${dto.image}</div>
            ...
            <div class="field">
                ...
                <c:choose>
                    <c:when test="${empty board.savefilename}">
                        <img src="/upload/noname.jpg" height="80" style="text-align: left;">
                    </c:when>
                    <c:otherwise>
                        <img src="/upload/${board.savefilename}" height="80" style="text-align: left;">
                    </c:otherwise>
                </c:choose>&nbsp;&nbsp;
            </div>
            ...
            <div class="field">
                ...
                <input type="button" value="되돌아가기" onClick="location.href='boardViewWithoutCnt?=${board.num}'"/>
            </div>
